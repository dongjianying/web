	...
	local: {
		playlist: [
			...
			},
			{
				name: "亮片",
				artist: "驼儿",
				url: "/assets/music/亮片-驼儿.mp3",
				cover: "/assets/music/cover/1.jpg",
				lrc: "/assets/music/亮片-驼儿-歌词.lrc",
			},
			{
				name: "落日飞行器 (氛围版)",
				artist: "你在暮色中",
				url: "/assets/music/落日飞行器 (氛围版)-你在暮色中.mp3",
				cover: "/assets/music/cover/1.jpg",
				lrc: "",
			},
			{
				name: "顽家",
				artist: "Jony J",
				url: "/assets/music/顽家-Jony J.mp3",
				cover: "/assets/music/cover/1.jpg",
				lrc: "/assets/music/顽家-Jony J-歌词.lrc",
			},
			{
				name: "山脚",
				artist: "Jony J",
				url: "/assets/music/Jony J - 山脚.mp3",
				cover: "/assets/music/cover/1.jpg",
				lrc: "/assets/music/山脚 (Beyond The Summit)-Jony J-歌词.lrc",
			},
			{
				name: "Up Up and Away",
				artist: "xxxtentaction",
				url: "/assets/music/Up Up and Away-xxxtentaction.mp3",
				cover: "/assets/music/cover/1.jpg",
